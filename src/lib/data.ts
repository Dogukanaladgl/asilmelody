...
export interface Exhibit {
  ...
  /** object-cover odak noktası — üst yazılı kapaklarda örn. "center 28%" */
...
/** Yeniden eskiye — müzik bölümünde son eklenenler üstte */
...
export const spotifyPlaylist = {
  ...
  coverImage: "/images/exhibits/timsah-gozyasi.webp",
